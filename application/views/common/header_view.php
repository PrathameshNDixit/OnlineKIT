  ...
  <div class="contener_general">
        ...
        <div class="side-content-wrap">
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <ul class="childNav"  data-parent="forms">
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Master/applied"><i class="fa-lg fas fa-user-graduate" aria-hidden="true"></i><span class="item-name">&nbsp;Applied</span></a></li>
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Master/Masteredu"><i class="fa-lg fas fa-graduation-cap" aria-hidden="true"></i><span class="item-name">&nbsp;Masteredu</span></a></li>
                ...
                <li class="nav-item"><a href="<?=base_url();?>Master/bldtype"><i class="fa-lg far fa-keyboard" aria-hidden="true"></i><span class="item-name">&nbsp;Blood Group</span></a></li>
                <li class="nav-item"><a href="<?=base_url();?>Master/emptype"><i class="fa-lg far fa-keyboard" aria-hidden="true"></i><span class="item-name">&nbsp;Employee Type</span></a></li>
                ...
                <li class="nav-item"><a href="<?=base_url();?>Master/branchlocation"><i class="fa-lg fas fa-building" aria-hidden="true"></i><span class="item-name">&nbsp;branchlocation</span></a></li>
    ...
    <!-- Sidebar -->
                ...
                <ul class="childNav " data-parent="blogs">
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Blogs/edit"><i class="fas fa-pen-square fa-lg animtxt" aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Edit Blog</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Blogs/delete"><i class="fas fa-pen-square fa-lg animtxt" aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Delete Blog</span></a></li>
                ...
                <ul class="childNav" data-parent="widgets">
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Opening/Deactivateopening"><i class="fas fa-trash fa-lg animtxt" aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Deactive&nbsp;Opening</span></a></li>
                    <li class="nav-item"><a href="<?=base_url();?>Opening/delete"><i class="fas fa-trash fa-lg animtxt" aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Delete&nbsp;Opening</span></a></li>
                ...
                <ul class="childNav" data-parent="student">
                    ...
                    <li class="nav-item"><a href="<?=base_url();?>Studentregistration/RegistrationDeactivated"><i class="fa fa-lg fa-user-times animtxt" aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Deactivat&nbsp;Student</span></a></li>
